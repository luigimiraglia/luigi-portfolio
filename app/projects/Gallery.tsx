...
export default function Gallery({ images }: { images: string[] }) {
  ...
  return (
    <div className="relative">
      ...
      <button aria-label="Prev" onClick={prev} className="btn-soft absolute left-2 top-1/2 -translate-y-1/2 rounded-full px-2 py-2">
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="15 18 9 12 15 6" /></svg>
      </button>
      <button aria-label="Next" onClick={next} className="btn-soft absolute right-2 top-1/2 -translate-y-1/2 rounded-full px-2 py-2">
