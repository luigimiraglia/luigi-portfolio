      ...
      <header className="glass-box relative z-10 mx-4 my-8 grid max-w-screen-xl grid-cols-1 items-center gap-10 px-6 py-6 sm:grid-cols-[auto,1fr] sm:px-8 sm:py-8 xl:mx-auto">
        ...
        <hgroup className="flex flex-col items-center gap-3 text-center">
          ...
          <ul className="mt-4 flex flex-wrap items-center justify-center gap-3 text-sm text-neutral-700/90">
            <li>
              <a
                href="https://linkedin.com/in/luigimiraglia"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 rounded-full bg-white/80 px-3 py-1 backdrop-blur hover:bg-white/90"
              >
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src="/linkedin.svg" alt="LinkedIn" width={18} height={18} />
                <span className="text-neutral-700">LinkedIn</span>
                <span aria-hidden className="text-neutral-400 text-[11px]">↗</span>
              </a>
            </li>
            <li>
              <a
            ...
            <li>
              <a
                href="https://leetcode.com/u/luigimiraglia"
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 rounded-full bg-white/80 px-3 py-1 backdrop-blur hover:bg-white/90"
              >
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img src="/leetcode.svg" alt="LeetCode" width={18} height={18} />
                <span className="text-neutral-700">LeetCode</span>
                <span aria-hidden className="text-neutral-400 text-[11px]">↗</span>
              </a>
            </li>
          </ul>
...
function ImgCarousel({ images }: { images: string[] }) {
  ...
  return (
    <div className="relative mt-3">
      {/* On mobile, make the image wider for better visibility */}
      <div className="img-frame relative mx-auto w-[92%] sm:w-[68%] md:w-[54%] overflow-hidden rounded-2xl bg-white ring-1 ring-neutral-200/70 shadow-[0_24px_60px_-28px_rgba(2,6,23,0.35)]">
        <Image
          src={src}
          alt="preview"
          width={1024}
